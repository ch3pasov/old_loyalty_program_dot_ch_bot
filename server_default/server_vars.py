...
creator_username_admin = "a"  # юзернейм меня, чтобы создавать очереди в админке очередей
...
loyalty_program = [
    ...
    LoyaltyLevel(level=11, days=35, reward=0.0032, congrats_text='🤪🤪', congrats_link='https://youtu.be/kGGoeDrjL5g'),
    LoyaltyLevel(level=12, days=42, reward=0.0064, congrats_text='🚬🤡', congrats_link='https://youtu.be/o3bxfyq1wrk'),
    LoyaltyLevel(level=13, days=49, reward=0.0032, congrats_text='👨‍🎨🤡', congrats_link='https://youtu.be/eMbNihx1BNk'),
    LoyaltyLevel(level=14, days=50, reward=0.0064, congrats_text='🐶✂️', congrats_link='https://youtu.be/z2xgSgAVQ-E'),
    LoyaltyLevel(level=15, days=60, reward=0.0128, congrats_text='🐹🍼', congrats_link='https://youtu.be/UlM-DiHbJXE'),
    LoyaltyLevel(level=16, days=75, reward=0.0064, congrats_text='🐷', congrats_link='https://youtu.be/taOw0intSWk'),
    LoyaltyLevel(level=17, days=90, reward=0.0256, congrats_text='👠⚽️', congrats_link='https://youtu.be/eHe3WUdRnaE?t=126'),
